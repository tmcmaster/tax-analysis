...
export class TmLineGraph extends LitElement {
...
// Change chart size according to window size
        ...
        chartObj.bind = function (mainDiv, chartDiv) {
            chartObj.mainDiv = d3.select(mainDiv);
            ...
            chartObj.chartDiv = d3.select(chartDiv);
...
window.customElements.define('tm-line-graph', TmLineGraph);
